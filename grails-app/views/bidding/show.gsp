	...
	<body>
		...
		<div id="show-bidding" class="content scaffold-show" role="main">
			...
			<ol class="property-list bidding">
				...
				<g:if test="${biddingInstance?.biddingPrice}">
				<li class="fieldcontain">
					<span id="biddingPrice-label" class="property-label"><g:message code="bidding.biddingPrice.label" default="Bidding Price" /></span>
					
						<span class="property-value" aria-labelledby="biddingPrice-label"><g:fieldValue bean="${biddingInstance}" field="biddingPrice"/></span>
				...
				<g:if test="${biddingInstance?.lastUpdated}">
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="bidding.lastUpdated.label" default="Last Updated" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate date="${biddingInstance?.lastUpdated}" /></span>
